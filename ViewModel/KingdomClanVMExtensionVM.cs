...
namespace DiplomacyFixes.ViewModel
{
    class KingdomClanVMExtensionVM : KingdomClanVM, INotifyPropertyChanged, ICloseableVM
    {
        ...
        private void RefreshCanUsurpThrone()
        {
            ...
            this.UsurpThroneHint = errorMessage != null ? new HintViewModel(new TextObject(errorMessage).ToString()) : new HintViewModel();
        ...
        private void RefreshCanGrantFief()
        {
            ...
            this.GrantFiefHint = this.CanGrantFiefToClan ? new HintViewModel() : new HintViewModel(new TextObject(hint).ToString());
        }
